...
weather_params.extend(["<high-temp-cold?>", "<high-temp-hot?>", "<low-temp-cold?>", "<low-temp-hot?>", "<current-temp-cold?>", "<current-temp-hot?>", "<is-rain?>", "<is-clear?>", "<is-overcast?>", "<high-humidity?>", "<low-humidity?>", "<high-wind-speed?>", "<low-wind-speed?>"])
